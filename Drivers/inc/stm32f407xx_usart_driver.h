...
typedef struct
{
	...
	uint8_t			TxBusyState;			/*!<To store Communication state   @I2C_application_status>*/
...
//@USART_Mode  Possible options for USART_Mode
...
//USART application event callback definitions
#define USART_EVENT_TX_CMPLT	0
#define USART_EVENT_RX_CMPLT	1
#define USART_EVENT_CTS			2
#define USART_EVENT_ORE			3
#define USART_EVENT_RX_IDLE		4
