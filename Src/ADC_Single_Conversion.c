 ...
 * and displays the calculated value in the ITM Data Console. Three LEDs are
 * connected to pins PA13(red), PA14(yellow), and PA15(green). If the calculated
 * value reaches 245, then the red LED will be lit, if the value is in
 * between(inclusive) 244 and 16, then the yellow LED will be lit. Else the
...
int main(void)
{
	...
	while(1)
	{
		...
		ADC_StartSingleConv(ADC_IN.pADCx, ADC_REGULAR_GROUP);
